...
public interface MedicationManager {
    ...
    Optional<MedicationDTO> findByIdForCurrentUser(@NotNull UUID id);
    ...
    @Transactional
    MedicationDTO updateForCurrentUser(@NotNull UUID id, @Valid UpdateMedicationRequestDTO request);
}
