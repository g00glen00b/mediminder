...
@Component
class UnverifiedUserCleanupReader extends RepositoryItemReader<UserEntity> {
    private final UserCodeCleanupProperties properties;
    private final Clock clock;

    public UnverifiedUserCleanupReader(UserEntityRepository repository, UserCodeCleanupProperties properties, Clock clock) {
        this.setRepository(repository);
        this.setMethodName("findAllWithVerificationCodeAndLastModifiedBefore");
