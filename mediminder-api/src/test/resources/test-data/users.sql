insert into "user" (id, email, password, name, timezone, enabled, admin, verification_code, password_reset_code, last_modified_date) values
    ...
    ('44a9dc13-9549-4252-98d1-1bc84e31efcf', 'me3@example.org', '$2a$10$pGHaZntc0vwL/Ogyi.hxJOoTlksKRYLxI8lTMN4obWrqqQmVEoI3a', 'User 4', null, false, false, 'code3', null, '2024-06-29 10:00:00'),
